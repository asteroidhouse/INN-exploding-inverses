...
for i in range(1):
    tfr = 'data/celebA256/train/train-r08-s-{:04d}-of-0120.tfrecords'.format(i)
...
torch.save(train_imgs, 'data/celebA256/celeba256_train-small.pth')

validation_imgs = []
for i in range(1):
    tfr = 'data/celebA256/validation/validation-r08-s-{:04d}-of-0040.tfrecords'.format(i)
    print(tfr, flush=True)
...
torch.save(validation_imgs, 'data/celebA256/celeba256_validation-small.pth')
